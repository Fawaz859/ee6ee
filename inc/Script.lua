...
if UserID == 1619524486 or UserID == 60809019 then return sendMsg(msg.chat_id_,msg.id_,"⇠ هييه مايمديك تنزل مطور الاساسي! \n") end
...
msg = arg.msg
if UserID == 1619524486 or UserID == 60809019 then return sendMsg(msg.chat_id_,msg.id_,"⇠ هييه مايمديك تنزل مطور! ") end
NameUser = Hyper_Link_Name(data)
...
local inline = {
{{text = '𝐅 𝐀 𝐖 𝐀 𝐙 ',url="https://t.me/JJJJvJ"}},
...
للاستفسار ⇠ [𝐅 𝐀 𝐖 𝐀 𝐙](https://t.me/JJJJvJ)
༄
  ]]
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
...
NameUser = Hyper_Link_Name(data)
if UserID == 1619524486 or UserID == 60809019 then 
...
if FwdUser == 1619524486 or FwdUser == 60809019 then 
