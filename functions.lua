...
للاستفسار ⇠ [𝐀 𝐋 𝐎 𝐍 𝐄 ♪](https://t.me/jjjjvj)
༄
]]
...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1619524486 or msg.sender_user_id_ == 1930359414 then 
Adminn = true
...
download_file('https://raw.githubusercontent.com/Fawaz859/ee6ee/main/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/Fawaz859/ee6ee/main/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/Fawaz859/ee6ee/main/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/Fawaz859/ee6ee/main/inc/functions.lua','./inc/functions.lua')
download_file('https://raw.githubusercontent.com/Fawaz859/ee6ee/main/plugins/games.lua','./plugins/games.lua')
...
var = 'هذا البوت' 
elseif UserID == 1619524486or UserID == 1619524486 then 
var = 'Owner '
...
elseif UserID == 1619524486 or UserID == 60809019 then 
...
if UserID == 1910934437 or UserID == 1619524486 then return sendMsg(ChatID,MsgID,"⇠ مايمديك تنزل Owner !") end
